...
//		LOGGER.info("Starting extraction for ImageSet located at: " + is.getFile().getAbsolutePath());
		System.out.println("Starting extraction for ImageSet located at: " + is.getFile().getAbsolutePath());

		for (ImageClass ic : is.getImageClasses()) {
			for (Image i : ic.getImages()) {
				long start = System.currentTimeMillis();
				
				System.out.println("Extracting image in: " + i.getFile().getAbsolutePath());
				...
				System.out.println("in extract imageset:"+i);
			}
		}
	}
