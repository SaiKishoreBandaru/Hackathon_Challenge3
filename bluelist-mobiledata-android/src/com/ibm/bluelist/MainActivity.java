...
public class MainActivity extends Activity {
	...
	public void createItem(View v) {
		ImageView itemToAdd = (ImageView) findViewById(R.id.imageView1);
		//String toAdd = itemToAdd.getText().toString();
		Bitmap bm=this.photo;
		Item item = new Item();
	 ...
	 */
	private void sortItems(List<Bitmap> itemList2) {
		// Sort collection by case insensitive alphabetical order.
		Collections.sort(itemList2, new Comparator<Bitmap>() {
	...
	private ActionMode.Callback mActionModeCallback = new ActionMode.Callback() {
	    ...
	    public boolean onActionItemClicked(ActionMode mode, MenuItem item) {
	    	Bitmap lItem = itemList.get(listItemPosition);
